...
const CardInfo = ({ route }) => {
  ...
  const { total } = route.params; // Retrieve total from PaymentMethods screen
  ...
  const backBtn = () => {
    // navigation.navigate('PaymentMethods', {item:Item Data});
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.closeButton} onPress={backBtn}>
